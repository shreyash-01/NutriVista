        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-wrap justify-left small:justify-center mb-2">
                {data.map((product, index) => (
                    <div onClick={()=>handleClick(product)} className="flex flex-col items-center justify-start small:w-[90vw] small:h-80 small:mb-5 small:ml-0 w-[23vw] h-[25vw] border border-gray-300 rounded-lg ml-6 mt-6 hover:scale-105 cursor-pointer" key={index}>
